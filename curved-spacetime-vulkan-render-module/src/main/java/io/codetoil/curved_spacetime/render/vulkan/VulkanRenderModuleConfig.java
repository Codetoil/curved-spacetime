...
/**
 * The Vulkan render module's settings, read from {@code config/vulkan-render-module.config}.
 * <p>
...
public class VulkanRenderModuleConfig implements ModuleConfig
{
	...
	public VulkanRenderModuleConfig load() throws IOException
	{
		...
		try (FileReader reader = new FileReader(VulkanRenderModuleConfig.FILENAME))
		{
			props.load(reader);
	...
	public void save() throws IOException
	{
		...
		try (FileWriter writer = new FileWriter(VulkanRenderModuleConfig.FILENAME))
		{
