...
dependencies {
    ...
    api(project(":curved-spacetime-ffm-vulkan-module"))
    api(project(":curved-spacetime-ffm-glfw-render-module"))
    api(project(":curved-spacetime-ffm-vulkan-render-module"))
    ...
    publications {
        register<MavenPublication>("gpr") {
            pom {
                ...
                name = "Curved Spacetime FFM Vulkan GLFW Render Module"
