...
public class FFMVulkanRenderModuleDependentFFMVulkanGLFWRenderModuleEntrypoint
		implements FFMVulkanRenderModuleDependentModuleInitializer
{

	@Override
	public void onInitialize(FFMVulkanRenderModuleEntrypoint ffmVulkanRenderModuleEntrypoint)
	{
		try
		{
			MainModuleEngine.getInstance().getCurvedSpacetimeLoader()
					...
					.transfer(ffmVulkanRenderModuleEntrypoint);
