...
import io.codetoil.curved_spacetime.render.glfw.ffm.FFMGLFWRenderModuleWindow;

import java.util.logging.Logger;

public class FFMVulkanGLFWRenderModuleWindow extends FFMGLFWRenderModuleWindow
{
	public FFMVulkanGLFWRenderModuleWindow(MainModuleEngine mainModuleEngine, String title, Logger logger)
	{
