...
package io.codetoil.curved_spacetime.vulkan.ffm.entrypoint;
...
public interface FFMVulkanModuleDependentModuleInitializer extends ModuleDependentModuleInitializer<FFMVulkanModuleEntrypoint>
{
	/**
	 * Runs the mod initializer.
	 */
	void onInitialize(FFMVulkanModuleEntrypoint ffmVulkanModuleEntrypoint);
}
