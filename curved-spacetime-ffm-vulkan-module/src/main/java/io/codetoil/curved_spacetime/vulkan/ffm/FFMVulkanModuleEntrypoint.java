...
public class FFMVulkanModuleEntrypoint implements ModuleInitializer
{
	...
	private FFMVulkanModuleVulkan vulkan;
	...
	public void onInitialize()
	{
		...
		try
		{
			this.config = new FFMVulkanModuleConfig(this.logger).load();
		...
		MainModuleEngine.getInstance().registerMainCallback(this.vulkan
				= new FFMVulkanModuleVulkan(MainModuleEngine.getInstance(), this));
		try
		{
			MainModuleEngine.callDependents("vulkan_module_dependent", FFMVulkanModuleDependentModuleInitializer.class,
					(FFMVulkanModuleDependentModuleInitializer ffmVulkanModuleDependentModuleInitializer) ->
							ffmVulkanModuleDependentModuleInitializer.onInitialize(this), this.logger);
		} catch (Throwable e)
		{
	...
	public FFMVulkanModuleVulkan getVulkan()
	{
		return vulkan;
	}
}
