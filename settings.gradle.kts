...
include("curved-spacetime-ffm-vulkan-module")
...
include("curved-spacetime-ffm-glfw-render-module")
include("curved-spacetime-vulkan-render-module")
include("curved-spacetime-ffm-vulkan-render-module")
include("curved-spacetime-webserver-openapi-module")
include("curved-spacetime-vulkan-glfw-render-module")
include("curved-spacetime-ffm-vulkan-glfw-render-module")
...
project(":curved-spacetime-ffm-vulkan-module").name = "curved-spacetime-ffm-vulkan-module"
...
project(":curved-spacetime-ffm-glfw-render-module").name = "curved-spacetime-ffm-glfw-render-module"
project(":curved-spacetime-vulkan-render-module").name = "curved-spacetime-vulkan-render-module"
project(":curved-spacetime-ffm-vulkan-render-module").name = "curved-spacetime-ffm-vulkan-render-module"
...
project(":curved-spacetime-ffm-vulkan-glfw-render-module").name = "curved-spacetime-ffm-vulkan-glfw-render-module"
