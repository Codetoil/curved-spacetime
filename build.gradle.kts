...
project.extra["junitVersion"] = "6.0.2" // org.junit:junit-bom
...
project.extra["fabricMixinVersion"] = "0.17.0+mixin.0.8.7" // net.fabricmc:sponge-mixin

// QuiltMC Maven - https://maven.quiltmc.org/repository/release/
project.extra["quiltLoaderVersion"] = "0.30.0-beta.0" // org.quiltmc:quilt-loader, org.quiltmc:quilt-loader-dependencies
