...
package io.codetoil.curved_spacetime.render.vulkan.ffm.entrypoint;
...
public interface FFMVulkanRenderModuleDependentModuleInitializer
		extends ModuleDependentModuleInitializer<FFMVulkanRenderModuleEntrypoint>
{
	/**
	 * Runs the mod initializer.
	 */
	void onInitialize(FFMVulkanRenderModuleEntrypoint ffmVulkanRenderModuleEntrypoint);
}
