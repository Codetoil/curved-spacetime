...
public class FFMVulkanModuleDependentFFMVulkanRenderModuleEntrypoint implements FFMVulkanModuleDependentModuleInitializer
{
	...
	public void onInitialize(FFMVulkanModuleEntrypoint ffmVulkanModuleEntrypoint)
	{
		try
		{
			MainModuleEngine.getInstance().getCurvedSpacetimeLoader()
					...
					.filter(FFMVulkanRenderModuleEntrypoint.class::isInstance)
