...
public class FFMVulkanRenderModuleFrameBuffer
{
	private final FFMVulkanModuleLogicalDevice logicalDevice;
	private final MemorySegment vkFrameBuffer;

	public FFMVulkanRenderModuleFrameBuffer(FFMVulkanModuleLogicalDevice logicalDevice, int width, int height,
	                                        ...
	                                        MemorySegment renderPass)
	{
		...
		FFMVulkanUtils.vkCheck(Vulkan.vkCreateFramebuffer(logicalDevice.getVkDevice(), framebufferCreateInfo,
