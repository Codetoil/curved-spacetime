...
public class FFMVulkanRenderModuleSwapChainRenderPass
{
	private final FFMVulkanRenderModuleSwapChain swapChain;
	private final MemorySegment vkRenderPass;

	public FFMVulkanRenderModuleSwapChainRenderPass(FFMVulkanRenderModuleSwapChain swapChain)
	{
		...
		FFMVulkanUtils.vkCheck(Vulkan.vkCreateRenderPass(swapChain.getVulkanLogicalDevice().getVkDevice(),
