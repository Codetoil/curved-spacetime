...
public abstract class FFMVulkanRenderModuleSurface
{
	protected final FFMVulkanModulePhysicalDevice ffmVulkanModulePhysicalDevice;
	protected final Logger logger;

	public FFMVulkanRenderModuleSurface(FFMVulkanModulePhysicalDevice ffmVulkanModulePhysicalDevice, Logger logger)
	{
	...
	protected VulkanRenderSurfaceFormat calcSurfaceFormat()
	{
		...
		FFMVulkanUtils.vkCheck(Vulkan.vkGetPhysicalDeviceSurfaceFormatsKHR(this.ffmVulkanModulePhysicalDevice
