...
public class SimulatorModuleEntrypoint implements ModuleInitializer
{
	...
	public void onInitialize()
	{
		...
		{
			throw new RuntimeException("Failed to load Simulator Module Config", ex);
		}
		try
		{
			Engine.callDependents("simulator_module_dependent", SimulatorModuleDependentModuleInitializer.class,
