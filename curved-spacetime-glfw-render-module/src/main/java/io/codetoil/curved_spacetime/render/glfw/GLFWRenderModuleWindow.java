...
public abstract class GLFWRenderModuleWindow extends RenderModuleWindow
{
	...
	protected GLFWRenderModuleWindow(String title)
	{
		super(title);
	}
	...
	public void init()
	{
		...
		this.keyboardInput = new GLFWRenderModuleKeyboardInput(this);
		GLFW.glfwSetFramebufferSizeCallback(this.windowHandle, (window, w, h) -> {
			width = w;
			height = h;
		});

		this.mouseInput = new GLFWRenderModuleMouseInput(this);
	}
