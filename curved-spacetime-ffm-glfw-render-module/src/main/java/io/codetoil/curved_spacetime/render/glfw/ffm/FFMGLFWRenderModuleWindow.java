...
public abstract class FFMGLFWRenderModuleWindow extends RenderModuleWindow
{
	protected long window;
	protected int width;
	protected int height;

	protected FFMGLFWRenderModuleWindow(MainModuleEngine mainModuleEngine, String title, Logger logger)
	{
	...
	public void init()
	{
		...
		this.renderModuleKeyboardInput = new FFMGLFWRenderModuleKeyboardInput(this);
		...
		this.renderModuleMouseInput = new FFMGLFWRenderModuleMouseInput(this);
	}
