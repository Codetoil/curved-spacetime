...
public class RenderModuleDependentFFMGLFWRenderModuleEntrypoint implements RenderModuleDependentModuleInitializer
{
	...
	public void onInitialize(RenderModuleEntrypoint renderModuleEntrypoint)
	{
		try
		{
			MainModuleEngine.getInstance().getCurvedSpacetimeLoader()
					...
					.filter(FFMGLFWRenderModuleEntrypoint.class::isInstance)
