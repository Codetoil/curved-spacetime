...
package io.codetoil.curved_spacetime.render.glfw.ffm.entrypoint;
...
public interface FFMGLFWRenderModuleDependentModuleInitializer
		extends ModuleDependentModuleInitializer<FFMGLFWRenderModuleEntrypoint>
{
	/**
	 * Runs the mod initializer.
	 */
	void onInitialize(FFMGLFWRenderModuleEntrypoint ffmglfwRenderModuleEntrypoint);
}
