...
public abstract class FFMGLFWRenderModuleRenderer extends SceneCallback
{
	protected FFMGLFWRenderModuleRenderer(MainModuleEngine mainModuleEngine, Scene scene)
	{
