	...
	public static void vkCheck(int err, String errMsg)
	{
		...
		switch (err)
		{
			...
			case VK13.VK_ERROR_TOO_MANY_OBJECTS:
				...
				errDesc = "Too many objects of the type have already been created.";
				break;
			case VK13.VK_ERROR_FORMAT_NOT_SUPPORTED:
				errCode = "VK_ERROR_FORMAT_NOT_SUPPORTED";
				errDesc = "A requested format is not supported on this device.";
				break;
			case VK13.VK_ERROR_FRAGMENTED_POOL:
				errCode = "VK_ERROR_FRAGMENTED_POOL";
				errDesc = "A pool allocation has failed due to fragmentation of the pool's memory. This must only be" +
			...
			case VK13.VK_ERROR_UNKNOWN:
				...
				errDesc = "An unknown error has occurred; either the application has provided invalid input, or an" +
						" implementation failure has occurred.";
				break;
			case VK13.VK_ERROR_VALIDATION_FAILED:
				errCode = "VK_ERROR_VALIDATION_FAILED";
				errDesc = "A command failed because invalid usage was detected by the implementation or a validation " +
			...
			case VK13.VK_ERROR_INVALID_EXTERNAL_HANDLE:
				...
				errDesc = "An external handle is not a valid handle of the specified type.";
				break;
			...
			case VK13.VK_ERROR_FRAGMENTATION:
				...
				errDesc = "A descriptor pool creation has failed due to fragmentation.";
				break;
			...
			case KHRSurface.VK_ERROR_SURFACE_LOST_KHR:
				...
				errDesc = "A surface is no longer available.";
				break;
			...
			case KHRSwapchain.VK_ERROR_OUT_OF_DATE_KHR:
				...
				errDesc = "A surface has changed in such a way that it is no longer compatible with the swapchain, and" +
			...
			case KHRDisplaySwapchain.VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:
				...
				errDesc = "The display used by a swapchain does not use the same presentable image layout, or is" +
			...
			case KHRVideoQueue.VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR:
				...
				errDesc = "The requested VkImageUsageFlags are not supported.";
				break;
			case KHRVideoQueue.VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR:
				...
				errDesc = "The requested video picture layout is not supported.";
				break;
			case KHRVideoQueue.VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR:
				...
				errDesc = "A video profile operation specified via VkVideoProfileInfoKHR::videoCodecOperation is not" +
						" supported.";
				break;
			case KHRVideoQueue.VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR:
				...
				errDesc = "Format parameters in a requested VkVideoProfileInfoKHR chain are not supported.";
				break;
			case KHRVideoQueue.VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR:
				errCode = "VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR";
				errDesc = "Codec-specific parameters in a requested VkVideoProfileInfoKHR chain are not supported.";
				break;
			case KHRVideoQueue.VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR:
				errCode = "VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR";
				errDesc = "The specified video Std header version is not supported.";
				break;
			...
			case KHRDeferredHostOperations.VK_THREAD_DONE_KHR:
				...
				errDesc = "A deferred operation is not complete but there is no work remaining to assign to additional" +
						" threads.";
				break;
			case KHRDeferredHostOperations.VK_OPERATION_DEFERRED_KHR:
				errCode = "VK_OPERATION_DEFERRED_KHR";
				errDesc = "A deferred operation was requested and at least some of the work was deferred.";
				break;
			case KHRDeferredHostOperations.VK_OPERATION_NOT_DEFERRED_KHR:
				errCode = "VK_OPERATION_NOT_DEFERRED_KHR";
				errDesc = "A deferred operation was requested and no operations were deferred.";
				break;
			...
			case EXTImageCompressionControl.VK_ERROR_COMPRESSION_EXHAUSTED_EXT:
				...
				errDesc = "An image creation failed because internal resources required for compression are exhausted." +
			...
			case EXTShaderObject.VK_INCOMPATIBLE_SHADER_BINARY_EXT:
				...
				errDesc = "The provided binary shader code is not compatible with this device.";
				break;
			...
			case KHRPipelineBinary.VK_ERROR_NOT_ENOUGH_SPACE_KHR:
				...
				errDesc = "The application did not provide enough space to return all the required data.";
				break;
		}
