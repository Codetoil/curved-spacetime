...
abstract class AggregateJavadocPlugin implements Plugin<Project> {
    ...
    @Inject
    abstract JvmPluginServices getJvmPluginServices();

    @Override
    void apply(Project project) {
        project.getPlugins().apply(JavaBasePlugin.class)

        project.getPlugins().withType(JavaPlugin.class).configureEach(jp -> {
    ...
    Configuration getJavadocClasspath()
	{
