...
/**
 * Delivers the render module's entrypoint to the Vulkan GLFW render module.
 * <p>
 * Registered by the Vulkan GLFW render module under {@code render_module_dependent}. The render module invokes this during its
 * own initialization; it locates the Vulkan GLFW render module's main entrypoint through the loader and
 * transfers the render entrypoint into that module's dependency queue, where the Vulkan GLFW render module is
...
public class RenderModuleDependentVulkanGLFWRenderModuleEntrypoint implements RenderModuleDependentModuleInitializer
{
	 ...
	 */
	public RenderModuleDependentVulkanGLFWRenderModuleEntrypoint()
	{
	}
