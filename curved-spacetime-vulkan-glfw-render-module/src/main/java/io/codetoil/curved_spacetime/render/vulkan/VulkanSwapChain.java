...
public class VulkanSwapChain {
    ...
    public VulkanSwapChain(VulkanLogicalDevice vulkanLogicalDevice, VulkanSurface surface, VulkanWindow vulkanWindow,
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            Arrays.setAll(this.synchronizationVulkanSemaphoresList, i -> new SynchronizationVulkanSemaphores(this.vulkanLogicalDevice));
            this.currentFrame = 0;
    ...
    public int acquireNextImage() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            int err = KHRSwapchain.vkAcquireNextImageKHR(this.vulkanLogicalDevice.getVkDevice(), this.vkSwapChain,
                    ~0L, this.synchronizationVulkanSemaphoresList[currentFrame].imageAcquisitionVulkanSemaphore().getVkSemaphore(),
                    MemoryUtil.NULL, ip);
